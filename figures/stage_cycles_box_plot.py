...
_, _, node1_cycles, _, _, _ = parse_log_file(
    "../experiments/Scenario5 - Varying Spike/log_topology1_medium_spike/log_node1.log"
)
_, _, node2_cycles, _, _, _ = parse_log_file(
    "../experiments/Scenario5 - Varying Spike/log_topology1_medium_spike/log_node2.log"
)

_, _, node1_cycles_potc, _, _, _ = parse_log_file(
    "../experiments/Scenario6 - Partition Strategies/potc/Scenario5/topology1_medium/log_node1.log"
)
_, _, node2_cycles_potc, _, _, _ = parse_log_file(
    "../experiments/Scenario6 - Partition Strategies/potc/Scenario5/topology1_medium/log_node2.log"
)

_, _, node1_cycles_pkg, _, _, _ = parse_log_file(
    "../experiments/Scenario6 - Partition Strategies/pkg/Scenario5/topology1_medium/log_node1.log"
)
_, _, node2_cycles_pkg, _, _, _ = parse_log_file(
    "../experiments/Scenario6 - Partition Strategies/pkg/Scenario5/topology1_medium/log_node2.log"
)

# Load aggregation node cycles if they exist
_, _, node1_aggr_cycles, _, _, _ = parse_log_file(
    "../experiments/Scenario6 - Partition Strategies/pkg/Scenario5/topology1_medium/log_node1_aggr.log"
)
...
stage_cycles_pkg = calculate_stage_cycles(
    node1_cycles_pkg[4:], node2_cycles_pkg[4:], node1_aggr_cycles[4:1]
)
...
plt.boxplot(data, tick_labels=node_labels)
...
plt.tight_layout()
plt.savefig(
    "../experiments/Scenario6 - Partition Strategies/Scenario5 - comparison/stage_cycles_comparison_medium.png",
    format="png",
    dpi=300,
    bbox_inches="tight",
)
